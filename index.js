...
const url = "https://www.google.com/search?q=live+score+cricket";
...
async function start() {
    ...
    const titleElement = await page.waitForSelector('body');
    const info = await infoElement.evaluate(el => el.textContent);
